...
runners.forEach(function(item, first_name, last_name){
...
// runners.filter(function(item, shirt_size){
//   console.log(runnersLargeSizeShirt +`${item.shirt_size}` )
// });

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations and save the total into a ticketPriceTotal variable.
let ticketPriceTotal = 
runners.reduce(function(donation, total, item){
...
// Problem 1 (An employee wanted a list of last names in lower case. Use the .map()method)

let lwrCase = 
runners.map(function(item, last_name){
  console.log(`${item.last_name}`.toLowerCase());
});
